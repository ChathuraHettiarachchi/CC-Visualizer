...
export default function GraphCanvas({ events, sessionId, onNodeSelect, onSecondNodeSelect }: GraphCanvasProps) {
  ...
  // Note: formatNodeLabel, makeNodeLabel, makeStartRing, makeStatusRing, toolNodeSize, TYPE_VAL,
  //       startPulseMeshesRef, statusRingMeshesRef are all stable references — no dep needed
